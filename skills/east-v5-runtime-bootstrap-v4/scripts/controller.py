#!/usr/bin/env python3
"""Single executable entrypoint for the immutable v4 workspace Skill."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("command", choices=("claim-preflight", "business-preflight", "launcher-control-preflight", "orphan-audit", "run-task"))
    ...
    try:
        ...
        if args.command == "launcher-control-preflight":
            ...
            if controller.envelope["target_agent_id"] == "110":
                ...
                result = controller.launcher_control_preflight(Path(args.runtime_root).resolve(), task_id=args.task_id, runtime_id=args.runtime_id, launcher_record=record, launcher_fail=args.launcher_fail)
