"""Small standard-library-only immutable registry for the v5 controller."""
...
class ArtifactRegistry:
    ...
    def _state(self) -> Iterator[dict[str, Any]]:
        ...
        with self.lock_path.open("a+", encoding="utf-8") as lock:
            ...
            state = json.loads(self.path.read_text(encoding="utf-8")) if self.path.exists() else {"schema_version": "EAST-V5-RUNTIME-REGISTRY/v5", "records": []}
            yield state
