...
def event_material(*, duplicate: bool = False) -> tuple[dict, dict, dict]:
    ...
    reviewed_ref, context_ref = ref("reviewed-question-sql", "6"), ref("event-query-context", "7")
