...
_BOOTSTRAP_KEYS = {"bootstrap_version", "candidate_base_sha", "candidate_head_sha", "adapter_sha256", "bootstrap_sha256", "runner_sha256", "runtime_context"}
...
def validate_bootstrap_declaration(envelope: dict[str, Any]) -> dict[str, Any]:
    ...
    if not isinstance(declaration, dict) or set(declaration) != _BOOTSTRAP_KEYS:
